...
from model.Mellow import ModelMellow 
from common.Templete import Templete


class CllctMellow(ModelMellow, Templete):
    
    def __init__(self) -> None:
        ModelMellow.__init__(self)
    ...
    def jsonFileGenerate(self):
        ...
        '''
        if self.actionList:
            with open(f"{self.jsonFilePath}/{ModelMellow.FLAG}_{self.cllctTime}_.log", "a", encoding="utf-8") as jw:
